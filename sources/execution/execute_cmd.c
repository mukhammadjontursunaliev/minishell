...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/12/05 18:33:56 by mtursuna          #+#    #+#             */
/*   Updated: 2024/12/13 19:37:53 by mtursuna         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int execute_command(t_data *data, t_command *cmd)
{
    ...
    if (!cmd || !cmd->command)
        exit_shell(data, errmsg_cmd("child", NULL, "parsing error: no command to execute!", EXIT_FAILURE));
    ...
    if (ret == CMD_NOT_FOUND)
    {
        ...
        errmsg_cmd("command", cmd->command, "command not found", EXIT_FAILURE);
    }
